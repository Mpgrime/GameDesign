...
size=1,frame={224,208,209,225}
	...
	pushbtn={
		x={268,268,364,364,60,700,698},y={47,22,47,22,36,55,168},
		w=8,h=8,size=1,
		frame={112,114,116,118,120,120,116}
	}
	...
	plug={
	x={680,738},y={157,157},
	frame={222,238},w=8,h=8,size=1
	}	
	--battery cells
	bc={
	x={678,703},y={190,190},
	frame={40,56},w=8,h=8,size=1
	}	
	...
	if btn(⬆️) then
		...
		for i = 1,6 do
			...
			ball.x[i], ball.y[i], ball.w, ball.h) then
				...
				--if col w/ battery cell, cell moves:
			if i<3 and objcollision(cat.x,cat.y - 1,cat.w,cat.h,
			bc.x[i], bc.y[i], bc.w, bc.h) then
				bc.y[i] -= 1
				sfx(5) --cell moving sfx
				if mapCollision(bc.x[i],bc.y[i]-8,bc.collision, 0) then
					bc.y[i] += 1
					cat.y += 1
				end
			end
	...
	if btn(⬅️) then
		...
		for i = 1,6 do
			...
			if i < 3 and objcollision(
				...
				bc.x[i] -= 1
				sfx(5) --cell rolling sfx
				if mapCollision(bc.x[i],bc.y[i],bc.collision, 0) then
					bc.x[i] += 1
					cat.x += 1
				end
			end
	...
	if btn(➡️) then
		...
		for i=1,6 do
			...
			if i < 3 and objcollision(
				...
				--if col w/ battery cell, battery cell moves:
			if i < 3 and objcollision(
				cat.x + 1, cat.y, cat.w, cat.h,
				bc.x[i], bc.y[i], bc.w, bc.h
			) then
...
function factorypuzl(f,t,r)
	...
	if objcollision(f.x[1],f.y[1],f.w,f.h,
	t.x[1],t.y[1],t.w,t.h) then
		plug1=true
		t.frame[1]=239
	else
		plug1=false
	...
	if objcollision(f.x[2],f.y[2],f.w,f.h,
	t.x[2],t.y[2],t.w,t.h) then
		plug2=true
		t.frame[2]=223
	else
		plug2=false
	...
	if objcollision(cat.x,cat.y,cat.w,cat.h,
	pushbtn.x[7],pushbtn.y[7],pushbtn.w,pushbtn.h) and
	btnp(❎) then
		--/[resets cells when button pressed.
		f.x[1]=678
		f.y[1]=190
		f.x[2]=703
		f.y[2]=190
	...
	if plug1 and plug2 then
		r.unlocked = true
		r.frame = {173,157,174,158}
		if doorOpenSFX then 
			sfx(2)
			doorOpenSFX = false
		end
...
function interact_draw()
	...
	spr(pushbtn.frame[7],pushbtn.x[7],pushbtn.y[7],pushbtn.size,pushbtn.size)
	--flowers
	...
	--battery plugins
	spr(plug.frame[1],plug.x[1],plug.y[1],plug.size,plug.size)
		spr(plug.frame[2],plug.x[2],plug.y[2],plug.size,plug.size)
--battery cells
	spr(bc.frame[1],bc.x[1],bc.y[1],bc.size,bc.size)
	spr(bc.frame[2],bc.x[2],bc.y[2],bc.size,bc.size)
...

...

...

