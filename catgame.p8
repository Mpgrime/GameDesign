...
function factory_transitions()
	...
	if stage_check(cat,factory)==2 then
		if cat.y<=129 then
			cat.x=825
			cat.y=225
		end
	end
	if stage_check(cat,factory)==3 then
		if cat.y >= 240 then
			cat.x=720
			cat.y=147
		end
...
function debug_draw()
	...
	print(flower_solved,cat.x+16,cat.y+24,12)
end
...

__map__
...

